...
exports.template = `
<div class="item" v-bind:type="type" v-init="y" v-info="info" v-bind:style="DynamicStyle" v-bind:texture="texture" v-bind:fold="fold" v-on:mousedown="onMouseDown">
    <div class="warp">
        <div class="text">
            <span>
...
exports.directives =
{
	init( y )
	{
		this.vm.DynamicStyle.transform = `translateY(${y}px)`;
	},
	info( info )
	{
